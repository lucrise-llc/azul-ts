...
class AzulPage {
  constructor(config) {
    ...
    Object.defineProperty(this, 'azulURL', {
      enumerable: true,
      configurable: true,
      writable: true,
      value: void 0
  ...
  authHash(paymentPageRequest) {
    ...
    return crypto.createHmac('sha512', this.config.authKey).update(request).digest('hex');
  }
  createForm(userRequest) {
...
//# sourceMappingURL=azul-page.js.map
