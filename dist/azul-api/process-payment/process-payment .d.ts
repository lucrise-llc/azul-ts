...
import { ProcessPaymentResponse, ProcessPaymentSchemaInput, RefundSchemaInput } from './schemas';
export declare enum ProcessPaymentTransaction {
  SALE = 'Sale',
  HOLD = 'Hold',
  REFUND = 'Refund'
}
declare class ProcessPayment {
   ...
   */
  sale(input: ProcessPaymentSchemaInput): Promise<ProcessPaymentResponse>;
  /**
   ...
   */
  refund(input: RefundSchemaInput): Promise<ProcessPaymentResponse>;
  /**
   ...
   */
  hold(input: ProcessPaymentSchemaInput): Promise<ProcessPaymentResponse>;
}
export default ProcessPayment;
//# sourceMappingURL=process-payment%20.d.ts.map
